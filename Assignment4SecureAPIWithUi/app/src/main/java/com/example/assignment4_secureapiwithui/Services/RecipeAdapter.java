...
import com.example.assignment4_secureapiwithui.Controllers.EditRecipesActivity;
import com.example.assignment4_secureapiwithui.Controllers.MainActivity;
    ...
    public void onBindViewHolder(RecipeViewHolder holder, int position) {
        ...
        holder.EditButton.setOnClickListener(v -> {
            ...
            if (context instanceof MainActivity) {
                ((MainActivity) context).startActivityForResult(intent, MainActivity.EDIT_RECIPE_REQUEST_CODE);
            }
        });
